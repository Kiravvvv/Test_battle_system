...
public class Camera_free_rotation_state : Camera_state_abstract
{


    public Camera_free_rotation_state(Camera_control main_script, State_machine_camera stateMachine) : base(main_script, stateMachine)
    {
    }
